      ...
      <div className="flex justify-between items-center w-full h-full px-4 2xl:px-16 py-10">
        ...
        <div>
          <ul className="hidden md:flex items-center text-white">
            ...
            <li className="border-b border-transparent ml-10 text-sm uppercase hover:border-b hover:border-gray-300">
              <Link href="/package_avl" onClick={closeNav}>Packages</Link>
            </li>
            <li className="border-b border-transparent ml-10 text-sm uppercase hover:border-b hover:border-gray-300  ">
        ...
        <div className={`${nav ? "fixed left-0 top-0 w-[75%] sm:w-[60%] md:w-[45%] h-screen bg-white p-10 ease-in duration-500" : "fixed left-[-100%] top-0 p-10 ease-in duration-500"}`}>
          ...
          <div className="py-4 flex flex-col">
            <ul className="uppercase text-sm">
              <Link href="/" onClick={closeNav}><li className="py-4">Home</li></Link>
              <Link href="/package_avl" onClick={closeNav}><li className="py-4">Packages</li></Link>
              <Link href="/services" onClick={closeNav}><li className="py-4">Services</li></Link>
              <Link href="/blogs" onClick={closeNav}><li className="py-4">Blogs</li></Link>
              <Link href="/contactus" onClick={closeNav}><li className="py-4">Contact Us</li></Link>
            </ul>
