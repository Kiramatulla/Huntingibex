      ...
      <div className="max-w-6xl mx-auto bg-slate-100 my-6 font-[sans-serif] text-[#011c2b]">
        <div className="text-center px-6">
          ...
          <p className="text-sm text-gray-400 mt-3">
            Have some querries or questions and need help?
          </p>
        </div>
          ...
          <div className="bg-[#011c2b] rounded-lg p-6 max-lg:text-center">
            ...
            <ul className="mt-16 space-y-10">
              <li className="flex items-center max-lg:justify-center">
                ...
                >
                  <strong>ibexhunter@gmail.com</strong>
                </a>
              </li>
              <li className="flex items-center max-lg:justify-center">
                <svg
              ...
              <li className="flex items-center max-lg:justify-center">
                ...
                <a
                  ...
                  className="text-white text-sm ml-3"
                >
                  <strong>IbexHunting Pvt. Ltd Gulmit Gojal Hunza</strong>
                </a>
              </li>
            </ul>
