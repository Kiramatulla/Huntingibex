...
import trophyexpect from "../../../../public/images/trophyExpect.jpg";
import Link from "next/link"


export default function TrophyToExpect() {
  return (
    <div>
     <div className="bg-gray-200 pt-10 pb-10 md:pb-20 overflow-hidden">
      <div className="bg-white mt-10 mx-5 md:mx-28 pb-10 md:pb-28 pt-5 md:pt-10 rounded-lg shadow-md">
